 ...
 */
package com.suola.project.ui.utils.decoratorlib;

import com.suola.project.ui.utils.decoratorlib.backgrund.GNBackground;
import com.suola.project.ui.utils.decoratorlib.buttons.Close;
import com.suola.project.ui.utils.decoratorlib.buttons.GNFullscreen;
import com.suola.project.ui.utils.decoratorlib.buttons.Maximize;
import com.suola.project.ui.utils.decoratorlib.buttons.Minimize;
    ...
    public void initTheme(Theme theme){
        switch(theme){
            case DEFAULT :
                ...
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/default.css").toExternalForm());
                break;
            case DARK :
                this.background.getStylesheets().clear();
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/darkula.css").toExternalForm());
                break;
            case DANGER:
                this.background.getStylesheets().clear();
                // add theme
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/danger.css").toExternalForm());
                break;
            case INFO :
                this.background.getStylesheets().clear();
                // add theme
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/info.css").toExternalForm());
                break;
            case PRIMARY:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/primary.css").toExternalForm());
                break;
            case SECONDARY:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/secondary.css").toExternalForm());
                break;
            case SUCCESS:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/success.css").toExternalForm());
                break;
            case WARNING:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/warning.css").toExternalForm());
                break;
            case CUSTOM:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/styles/decorator/css/theme/custom.css").toExternalForm());
                break;
        }
    }
